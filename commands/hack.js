        ...
        if (hackSuccess) {
          ...
          const successEmbed = new EmbedBuilder()
            ...
            .addFields(
              ...
              { name: '📊 Success Rate', value: `${adjustedSuccessRate.toFixed(1)}%${infamySuccessBuff > 0 ? ` (+${infamySuccessBuff}% infamy)` : ''}${petHackOffense > 0 ? ` (🐾 +${petHackOffense.toFixed(1)}%)` : ''}${petHackDefense > 0 ? `\n🛡️ Target pet: -${petHackDefense.toFixed(1)}%` : ''}`, inline: true },
          ...
          const failEmbed = new EmbedBuilder()
            ...
            .addFields(
              ...
              { name: '📊 Success Rate', value: `${adjustedSuccessRate.toFixed(1)}%${petHackOffense > 0 ? ` (🐾 +${petHackOffense.toFixed(1)}%)` : ''}${petHackDefense > 0 ? `\n🛡️ Target pet: -${petHackDefense.toFixed(1)}%` : ''}`, inline: true },
              { name: '🎲 Roll', value: `${hackRoll.toFixed(1)}%`, inline: true }
            )
            .setFooter({ text: xpFooter })
            .setTimestamp();
