...
client.on('interactionCreate', async (interaction) => {
  ...
  if (interaction.isButton() || interaction.isStringSelectMenu() || 
    ...
    const adminCustomIds = [
      ...
      'lottery_toggle_auto', 'lottery_edit_schedule', 'lottery_edit_prizes', 'lottery_set_channel', 'lottery_edit_ticket_price', 'lottery_edit_range',
      ...
      'modal_blackjack_settings', 'modal_lottery_schedule', 'modal_lottery_prizes', 'modal_lottery_ticket_price', 'modal_lottery_range', 'modal_vault_spawn', 'modal_vault_reward',
